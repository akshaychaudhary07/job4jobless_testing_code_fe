...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule,CreateJobPostComponent,ReviewJobPostComponent,JobDetailsComponent,VerticalSliderComponent,PostJobComponent],  // Include HeaderComponent
